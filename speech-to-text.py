...
load_dotenv()
os.environ["OPENAI_API_KEY"] = "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"
...
def ask_openai(prompt):
    ...
    if "plot" in prompt.lower() or "graph" in prompt.lower():
        ...
        response = client.chat.completions.create(
            ...
            messages=[{ "role":"system","content":"You are a helpful assistant that answers the query by using given context in few words."},{ "role":"user","content":"Context: "+ context+"\n\n Query: "+prompt},]
        )
        collected_messages = []
